...
// 1.08		06/01/2010	Michael Wolf  * external memory bus is initialized now
//										before accessing the CAN controller first time
// 1.09		04/17/2016	Michael Wolf  * Changed BTR values for various CAN speeds
//
